...
---
title: "Module 8: Introduction to Gibbs Sampling (Part II) with an Application to Missing Data"
...
4. Finally, let's suppose that $r=10,a=1,b=100.$ Does your posterior change? What about when $r=10, a=10,b=1?$ (Use 10,000 iterations for the Gibbs sampler). 
