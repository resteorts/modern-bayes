...
$$p(\lambda, \bbeta \mid y, X) = p(\lambda \mid y, X) \times p(\bbeta \mid y,X, \lambda^{-1})$$

Goal: simulate $(\lambda, \beta) \sim p(\lambda, \bbeta \mid y, X)$

Starting value $(\beta_0, \lambda_0)$

1. Simulate $$\lambda^{-1} \sim p(\lambda \mid y, X)$$ Gives us  $(\lambda_1, \beta_0)$

2. Use this updated value of $\lambda_1$ to simulate 
$$\beta \sim p(\bbeta \mid y,X, \lambda)$$ Gives us $(\lambda_1, \beta_1)$
