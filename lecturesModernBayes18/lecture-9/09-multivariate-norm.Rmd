...
Using the samples from the Gibbs sampler, we have generated 5,000 samples $$(\bm{\theta}^{1}, Sigma(1), \ldots,\bm{\theta}^{1}, Sigma(1) )$$ that approxmiates $p(\theta, \Sigma \mid y_1, \ldots, y_n).$
