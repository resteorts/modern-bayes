...
\emph{Lab Time--01}: Friday: 12:00 -- 1:15 PM EST\\
\emph{Lab Time--02}: Friday: 1:45 PM -- 3:00 PM EST\\
%T/Th: 11:45 am -- 1:00 pm\\
\emph{Steorts Office Hours, 216 Old Chemistry}: TBD \\
%Tu: 1:00-3:00 PM (025 Old Chemistry if my office is full) \\
\emph{Course webpage:} \url{https://github.com/resteorts/modern-bayes} \\
