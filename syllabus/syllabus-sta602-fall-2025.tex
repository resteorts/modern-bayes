...
{\Large\bf Duke University, Fall 2025} \\
\end{center}
...
\emph{Course Time}: Monday/Wednesday: 10:00 AM -- 11:15 AM EDT, Perkins 217 \\\
\emph{Office Hour}: TBD \\
\textbf{972 7448 1273 (Class and OH ID)}\\
\emph{Course webpage:} \url{https://resteorts.github.io/teach/bayes25.html} \\
\emph{Academic calendar:} https://registrar.duke.edu/fall-2025-academic-calendar \\
\textbf{Please do not come to class if you're feeling sick/ill.}

\vspace*{1em}

\textbf{Please watch the lab videos each Thursday/Friday before coming to lecture/lab on Monday!}

\paragraph{Lab Schedule} 

\emph{Lab--01 with Gwen Jacobson, Phd Student, gwen.jacobson@duke.edu}: \\Thursday: 3:05 PM - 4:20 PM EDT, Old Chemistry 116 
\textbf{Meeting ID: XXXX}\\

\emph{Lab-02 with Raymond Sun, MS Student, raymond.sun@duke.edu}: \\Monday: 4:40 PM - 5:55 PM EDT: Old Chemistry 136 \textbf{Meeting ID: XXXX}\\
...
\begin{enumerate}
\item Gwen Jacobson, PhD Student, gwen.jacobson@duke.edu
\item  Raymond Sun, MS Student, raymond.sun@duke.edu
\end{enumerate}
...
\item Gwen Jacobson, PhD Student, XXXX, TBD (Backup: Raymond)\\
\textbf{Meeting ID: XXXXXXX}
\item Raymond Sun, MS Student, XXXX, TBD  (Backup: Gwen)\\
\textbf{Meeting ID: XXXXX}
\item There are no Thursday office hours given that there are two labs that students will be expected to attend (or watch pre-recorded videos) if they have questions. 
\end{enumerate}
...
\begin{enumerate}
\item Monday: Gwen (Backup: Raymond)
\item Tuesday: Raymond (Backup: Gwen)
\item Wednesday: Gwen (Backup: Raymond)
\item Thursday: Raymond (Backup: Gwen)
\item Friday: Gwen (Backup: Raymond)
\item Saturday: Raymond (Backup: Gwen)
\item Sunday: Gwen (Backup: Raymond)
\end{enumerate}

Please post messages to Ed Discussion. If you're not sure if the message should be shared with the entire class, please opt to share only with instructors. 
...
%Duke Student Government has worked with DukeReach and student advocates to create the Fall 2020 ``Two-Click Support" Form, and Duke Reach has expanded its drop in hours as well. 
