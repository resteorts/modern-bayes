...
\emph{Lab-02 with Emily Tallman, PhD Student, emily.tallman@duke.edu}: \\Friday: 1:45 PM -- 3:00 PM EDT: Old Chemistry 101 (Back up: XXXX) \\
...
\item Emily Tallman, PhD Student, Monday, 9:00 -- 10:00 AM EDT  (Backup: XXX)\\
\textbf{Meeting ID: 974 1981 3582}
...
\begin{enumerate}
\item Monday: Emily (Backup: Aihua)
\item Tuesday: Aihua (Backup: Yijia)
\item Wednesday: Yijia (Backup: Emily)
\item Thursday: Emily (Backup: Aihua)
\item Friday: Aihua (Backup: Yijia)
\item Saturday: Yijia (Backup: Emily)
