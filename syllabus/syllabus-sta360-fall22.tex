...
\emph{Course webpage:} \url{https://resteorts.github.io/teach/bayes22.html} \\x
...
\emph{Lab--01 with Evan Knox}: Monday 1:45pm - 3:00pm EDT, Old Chemistry 003 (Back up: Flora) 
...
\item Chen (Flora) Shi, Undergraduate Student, chen.shi@duke.edu
\end{enumerate}
...
\begin{enumerate}
\item Evan Knox, Wednesday 5:00 -- 6:00 PM EDT  (Backup: Flora)\\
\item Lexin Lu, Wednesday/Friday, 9:00 -- 10:00 AM EDT  (Backup: Evan)\\
\item Chen (Flora) Shi, Tuesday/Thursday, 7:00 -- 8:00 PM EDT (Backup: Lexin)\\
...
\begin{enumerate}
\item Monday: Evan (Backup: Flora)
\item Tuesday: Flora (Backup: Lexin)
\item Wednesday: Lexin (Backup: Evan)
\item Thursday: Evan (Backup: Flora)
\item Friday: Flora (Backup: Lexin)
\item Saturday: Lexin (Backup: Evan)
\item Sunday: Evan (Backup: Flora)
\end{enumerate}
...
I would like to thank Duke University, Mine Cetinkaya-Rundel, and Maria Tacket for help/advice with preparing this document and allowing me to share resources they have prepared in the past. 
