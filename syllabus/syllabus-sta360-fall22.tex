...
\textbf{967 9852 0140 (Class and OH ID)}\\
\emph{Course webpage:} \url{https://resteorts.github.io/teach/bayes22.html} \\
\emph{Academic calendar:} https://registrar.duke.edu/fall-2022-academic-calendar \\
\textbf{Please don't forget to wear your mask to class if it's required! Please do not come to class if you're feeling sick/ill.}


\paragraph{Lab Schedule}
\emph{Lab--01 with Evan Knox}: Monday 1:45pm - 3:00pm EDT, Old Chemistry 003 (Back up: Holly) 
...
\textbf{Please note that on the schedule labs should be completed by Friday and videos watched, so that you will be prepared for the Monday session with your TA's. Lab is not required, but encouraged and questions from lab may appear on homework and exams.} \\
...
\begin{enumerate}
\item Evan Knox, PhD Student, evan.knox@duke.edu
\item Lexin Lu, MS Student, lexin.lu@duke.edu
\item Holly Cui Undergraduate Student, yifan.cui@duke.edu
\end{enumerate}


\paragraph{TA Office Hours}
We will make adjustments to OH based upon student needs/feedback. All TA Office Hours will be held at \textbf{Meeting ID: 986 9865 5001}. 
\begin{enumerate}
...
\item There are no \textbf{Monday} OH given that there are two labs that students will be expected to attend (or watch pre-recorded videos) if they have questions. 
\end{enumerate}
...
\item Please name your reports using the naming convention in the following example. As an example, please using the following naming convention \textbf{steorts-rebecca-homework1.Rmd} and  \textbf{steorts-rebecca-homework1.pdf}
\item All homework submissions must be made through \textbf{Sakai and Gradescope}.
\item All homework's involving analysis and code must be submitted to Sakai using the students Rmarkdown file only (.Rmd). Specifically, your homework must be reproducible. Your PDF file should be uploaded to Gradescope.\footnote{If you are working with data in a homework assignment, please make sure to also attach the data and also make sure that when you call the data in your markdown file, there are no hard coded commands. For example, make sure you do not set the working directory because we won't be able to reproduce your file.}
%\item  \textbf{When submitting to Sakai, only one file must be uploaded.} Please zip together all materials for your homework assignment and upload the zipped file. As an example, please upload \textbf{steorts-rebecca-homework1.zip}, which should be a folder that contains \textbf{steorts-rebecca-homework1.Rmd}  and \textbf{steorts-rebecca-homework1.pdf}.\item \textbf{When submitting to Gradescope, please only upload the rendered .pdf file.}
\item \textbf{When submitting to Gradescope, please make sure to label your answers before submitting, and allowing ample time to do so. Points may be deducted if you fail to label your answers.}\\
\item Your reports are expected to be reproducible and compile for full credit. 
\item Students are expected to keep up with the reading in the course and have read before they come to class. Finally, if students find typos on the slides, please write them down with the slide and typo and give them to Professor Steorts for a timely correction to the course material.  
...
Homework assignments will be announced on Sakai (.Rmd) and Gradescope (.PDF). Homework assignments should be \textbf{uploaded to Sakai and Gradescope (per the instructions above).} The homework assignments will be posted on the course github page. Submissions via email to the TA's or instructor will not be accepted for credit. Derivations for homework can be submitted in any format of your choosing as long as you convert this to a pdf file. Your work must be legible to the instructor and the TA's. Recommendations that have worked well regarding derivations are Notability and Evernote. Other students have reported liking working with LaTeX within Rmarkdown. \\
...
\item[] Optional supplementary text:  \textit{Statistical Inference, Second Edition}. Casella and Berger 
...
\begin{tabular}{cc}
Homework &30\%\\
Exam I:  Thursday, October 6, 2022 &20\%\\
Exam  II: Thursday, TBD, 2022 & 20\%\\
Exam III:  Thursday, TBD, 2022 & 30\%\\
\end{tabular}
\end{center}
\label{default}
\end{table}%
...
Exam dates cannot be changed and no make-up exams will be given. In this case, your exam grade will be a zero. If extenuating circumstances prohibit you from taking an exam, please let Professor Steorts know before the start of the exam.\\
...
If your mental health concerns and/or stressful events negatively affect your daily emotional state, academic performance, or ability to participate in your daily activities, many resources are available to you, including ones listed below. If you're ever unsure of who to reach out to regarding a situation, myself, the Director of Undergraduate Studies, your advisor, or your academic dean are all good resources. 
...
\paragraph{Attribution and Thanks}
I would like to thank Duke University, Mine Cetinkaya-Rundel, and Maria Tacket for help/advice/editing with preparing this document and allowing me to share resources they have prepared in the past. Finally, I would like to thank Olivier Binette and Evan Knox for providing helpful feedback and improving its readability and clarity as teaching assistants of the course. 
