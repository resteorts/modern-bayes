...
\emph{Steorts Office Hours}: Tu: 1:00-3:00 pm (025 Old Chemistry if my office is full) \\
...
\emph{Course TA}:  Andrew Cooper (PhD Student), djandrewcooper@gmail.com (andrew.cooper@duke.edu)\\
...
\emph{Lab Time}: Wednesday, 11:45 AM - 1:00 PM\\
\emph{Office hours}: Wednesday, 4:00 PM -- 6:00 PM (203B Old Chemistry))\\
