...
Please see the syllabus for all exam guidelines. 

Typos
===

- If you find a typo on a slide, please
write it down neatly with the slide number and give it to me after class. 
...
- Please also note that one TA is responsible for emails each day, so please see the syllabus for this. 
...
- [Course webpage](http://www2.stat.duke.edu/~rcs46/bayes19.html)
