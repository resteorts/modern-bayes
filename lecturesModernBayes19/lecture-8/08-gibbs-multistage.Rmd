...
- At the end of class today, if everyone could fill out the course evaluation, I would be 
really appreciative. (Check your email for this). 
- Duke Undergraduate Machine Learning Day is Saturday March 23. You can register at \url{http://dukeml.org/} and 
see the full schedule of events. 
- If you're interested in doing an undergraduate thesis, poster presentations will be given by our seniors on Friday,
March 29 at 3:30 -- 4:30 PM, Brodhead Center Multipurpose Room, 068. 
- DataFest is April 6 -- 8 and you can register on the main statistical science page. 
- I will hand back Midterm II next week in class. Overall, the exams were quite good. Well done:) 
...
\begin{align*}
 & \textcolor{blue}{X_i\sim\N(\mu_{Z_i},\lambda^{-1}) \text{ independently for } i=1,\ldots,n.}\\
    ...
    & \pi \sim \Beta(a,b)
\end{align*}
 ($\mu|\cdots$) Given $z$, we know which component each data point comes from. 
    The model (conditionally on $z$) is just two
        independent Normal--Normal models, as we have seen before (Module 3):
        \begin{align*}
