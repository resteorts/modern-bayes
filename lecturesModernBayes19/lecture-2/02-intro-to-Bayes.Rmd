...
2. In addition to the Bayes procedure above, consider two other potential optimal decision rules: choosing $c = \bar x$ (sample mean) or $c=0.1$ (constant).
...
You may also find the PhD lecture notes helpful on this material, which are avaiable to you on the course webpage. 
