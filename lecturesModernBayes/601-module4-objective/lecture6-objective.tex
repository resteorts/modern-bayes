...
\item In statistics, it is often a good property when a rule for choosing a prior is \emph{invariant} under what are called one-to-one transformations. 
\item Invariant basically means unchanging in some sense.
...
\caption{Jeffreys' prior and the Uniform (0,1) prior}
\label{jeffreys}
\end{center}
\end{figure}
