...
%\item Finally, please look at the Rmd file that produces the above and the .pdf file. The code is well documented and well explained. This should serve as an example for what to strive for in terms of your homework write ups. (Also, please note how the plots are made
