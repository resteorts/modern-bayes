...
$$Mg(x) \geq \ell(x)$$ for all $x.$ Procedure:
...
- Please make sure that you arrive early and not late. 
...
- Two quizzes (ungraded). 
- Practice exercises: https://github.com/resteorts/modern-bayes/tree/master/exercises
- Review homework exercises
- Next Tuesday, there there will be a timed question at the start of the review session that is meant to help prepare you for the exam. We will go over it in class. 
