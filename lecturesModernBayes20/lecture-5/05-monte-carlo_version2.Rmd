...
Other approaches for generating samples
===
...
The inverse CDF method is a common way to generate samples from a univariate probability distribution when the inverse of the cdf cannot be easily computed. 

Basic Idea: Suppose $F^{-1}$ is the inverse cdf of $F$ and $U \sim \text{Uniform}(0,1)$. It follows that $F^{-1}(U)$ is a random variable with cdf F. 

Precise statement of inverse cdf method
===
