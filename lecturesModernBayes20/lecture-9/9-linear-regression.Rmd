...
&\propto \exp\{-\frac{1}{2}
[
\bbeta^T\textcolor{blue}{\frac{n\;X^TX}{\sigma^2}}\bbeta - 2\bbeta^T\textcolor{red}{\frac{X^T\bm{{y}}}{\sigma^2}}
]
\}
\end{align} 

This implies that $A_1 = \frac{n\;X^TX}{\sigma^2}$ and $\textcolor{red}{b_1 = \frac{X^T\bm{{y}}}{\sigma^2}}.$
...
where $$\mu_n = (\Sigma_0^{-1} + \frac{n\;X^TX}{\sigma^2})^{-1}(\Sigma_0^{-1}\bbeta_0 + \frac{X^T\bm{{y}}}{\sigma^2})$$ and
