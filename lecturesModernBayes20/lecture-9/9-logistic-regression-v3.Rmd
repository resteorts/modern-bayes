...
The natural parameter $\theta = \dfrac{p}{1-p}.$
...
The link function $g(\mu) = \log(\frac{\mu}{1-\mu})$ such that we model $\log(\frac{\mu}{1-\mu}) = \beta^TX.$ This is known as **logistic regression**. 
