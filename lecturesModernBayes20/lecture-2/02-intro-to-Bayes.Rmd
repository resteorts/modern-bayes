...
<!-- Formal Definition -->
<!-- === -->
<!-- A decision rule $\delta'$ \textbf{dominates} $\delta$ if -->
<!-- \[ -->
...
<!-- \begin{itemize} -->
<!--     \item $\delta$ is \textbf{inadmissible} if there exists a decision rule -->
<!--     $\delta'$ that dominates it. -->

<!--     \item $\delta$ is \textbf{admissible} if no decision rule $\delta'$ -->
<!--     dominates it. -->
<!-- \end{itemize} -->

<!-- \medskip -->

<!-- \alert{Key point:} To prove inadmissibility, it is enough to find -->
<!-- \emph{one} dominating rule. To prove admissibility, we must rule out -->
<!-- \emph{all} dominating rules. -->

<!-- \medskip -->

<!-- {\footnotesize -->
<!-- See, e.g., Berger (1985), \textit{Statistical Decision Theory and -->
<!-- Bayesian Analysis}, 2nd ed., Springer. -->
<!-- } -->

Example:  Inadmissible decision procedure 
===
...
<!-- Takeaways about inadmissible decision procedures -->
<!-- === -->

<!-- \begin{itemize} -->
<!--     \item \textbf{Inadmissibility:} It is enough to find \emph{one} estimator -->
<!--     that dominates $\delta$: -->
<!--     \[ -->
...
<!--     \item \textbf{Admissibility:} We must establish that \emph{no} estimator -->
<!--     dominates $\delta$. -->
<!-- \end{itemize} -->

<!-- \begin{itemize} -->
<!--     \item A \textbf{risk plot} can establish \textbf{inadmissibility} if one plotted -->
<!--     estimator dominates another. -->

<!--     \item If two risk curves \textbf{cross}, neither estimator dominates the other. -->

<!--     \item But this does \textbf{not} prove either estimator is admissible: -->
<!--     an unplotted estimator could still dominate it. -->
<!-- \end{itemize} -->
