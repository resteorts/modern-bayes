...
Evan Knox, PhD Student, Head TA

\begin{itemize}
\item Lab-01: Monday 1:45pm - 3:00pm EDT, Old Chemistry 003 (Backup: Holly)
Meeting ID: 954 6174 7646
\item Lab-02: Monday: 3:30 – 4:45 PM EDT: Allen 103 (Back up: Lexin)
Meeting ID: 954 6174 7646
\item Will hold OH
\end{itemize}
\textbf{Please note that structured lab material will be done in lab-01 and questions will be answered in lab-02. Labs are also pre-recorded in case you want to do this on your own. Your choice!}
...
\begin{itemize}
\item Will hold OH
\item Will answer questions over Piazza
\item Will be grading 
\end{itemize}
...
Holly Cui, Undergraduate Student
...
- Course syllabus [https://github.com/resteorts/modern-bayes/blob/master/syllabus/syllabus-sta360-fall22.pdf](https://github.com/resteorts/modern-bayes/blob/master/syllabus/syllabus-sta360-fall22.pdf)
...
3. You reproducible Rmd file is uploaded to Sakai. Your PDF file is uploaded to Gradescope. 
4. Ask questions early if you have a problem to a TA regarding submission issues. 
5. Your lowest homework will be dropped. 
6. The first four our homeworks can be submitted in Sakai and on GradeScope at anytime in case you want to work ahead. 
