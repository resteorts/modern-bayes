...
Yen-Chen Liu (yenchun.liu@duke.edu)

Yijie Huang (yijie.huang@duke.edu)
...
Lab 01: Thursday, 3:05 - 4:20 PM, Allen 106 

\vspace*{1em}
Lab 02: Thursday, 4:44 - 5:55 PM, Allen 106
...
**Course webpage**: [https://resteorts.github.io/teach/bayes-fall-25.html](https://resteorts.github.io/teach/bayes-fall-26.html)
...
- Access RStudio through [Docker container](https://cmgr.oit.duke.edu/containers) provided by Duke OIT (but not supported by the courses instuctors)
...
- You must label your own pages on Gradescope to avoid any deductions of points. 
...
-   Questions about grades, absences, and other private matters should be emailed to me with "STA 602" in the subject line. 

# Activities & Assessment

## Homework (20%)

-   6 - 8 individual assignments
...
-   All quiz grades will count toward your final grade. No late assignments will be accepted. 
