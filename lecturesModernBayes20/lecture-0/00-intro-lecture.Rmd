...
---
title: "Module 0: Introduction to Bayesian Statistics (STA 360/602)"
...
All classes are currently remote until notified due to COVID-19. 
...
\begin{itemize}
\item Class: Tues/Th, 10:15 -- 11:30 AM EDT 
\item OH: Tues/Th, 9:15 - 10:15 AM EDT (Zoom)
\item Zoom ID: 925 6381 7937
\item Course webpage: https://resteorts.github.io/teach/bayes22.html
\end{itemize}
...
\begin{itemize}
\item Lab-01: Monday: 1:45 PM – 3:00 PM EDT, Old Chemistry 025 (Back up: Evan)
\item Meeting ID: 979 3386 5844
\item Will hold OH and grade
\end{itemize}
...
Evan Knox, PhD Student

\begin{itemize}
\item Lab-02: Friday: 3:30 - 4:45 PM EDT, Old Chemistry 101 (Back up: Aihua)
\item Meeting ID: 979 3386 5844
\item Will hold OH and grade
\end{itemize}
...
- Course website (all major course information here): [https://resteorts.github.io/teach/bayes22.html](https://resteorts.github.io/teach/bayes22.html)
...
- Course syllabus [https://github.com/resteorts/modern-bayes/blob/master/syllabus/syllabus-sta602-spring-22.pdf](https://github.com/resteorts/modern-bayes/blob/master/syllabus/syllabus-sta602-spring-22.pdf)
...
- Sakai (upload homework Rmd file and any supporting files (data)): [https://shib.oit.duke.edu/idp/authn/external?conversation=e1s1](https://shib.oit.duke.edu/idp/authn/external?conversation=e1s1)

- Duke Gradescope (upload homework pdf only):
[https://gradescope.com/auth/saml/duke](https://gradescope.com/auth/saml/duke)

- See syllabus for detailed uploading instructions 
...
1. Please see the syllabus regarding homework instructions for Sakai and Gradescope. 
2. Please start the homework early and not late. 
3. Ask questions early and post to Piazza.  
4. Your lowest homework will be dropped. 
5. All homework assignments can be submitted in Sakai and on Gradescope in case you wish to work ahead in the course. 

Remark: Sakai is for reproducible code (you will receive a grade for this). Gradescope is to make grading is done fairly/consistently for all students. Unfortunately, there is not a platform that handles both. 
...
The format of the exams will be discussed closer to the time of the exam. The dates of the exams will be posted soon. 
...
- If you are an undergraduate, you will be graded as a graduate student in the course. 
