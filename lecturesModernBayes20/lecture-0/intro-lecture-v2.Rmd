...
- The videos are compressed, and this was done on purpose for those in the class that migth have slow internet. I would suggest that everyone forks the repository to avoid any issues. 
...
3. Check to see that you're able to navigate the course webpage via the wepbage and via your own computer (in case that you loose access to the internal). 
