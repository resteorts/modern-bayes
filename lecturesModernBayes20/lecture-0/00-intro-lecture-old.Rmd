...
\begin{itemize}
\item Class: Mo/Wed, 10:00 -- 11:45 AM EDT (Perkins 217)
\item OH: TBD (XXX)
\item Zoom ID: XXX
\item Course webpage: https://resteorts.github.io/teach/bayes-spring-25.html
\end{itemize}
...
\begin{itemize}
\item Lab-01: Thursday 3:05 -- 4:20 PM EDT, Old Chemistry 116 
Meeting ID: XXXXXX
\item Lab-02: Thursday: 4:40 -- 5:55 PM, Social Sciences 136
\end{itemize}
Meeting ID: XXXXXXX
...
Gwen Jacobson, PhD Student

\begin{itemize}
\item Will hold lab sessions
\item Will hold OH
...
- Course website (all major course information here): [https://resteorts.github.io/teach/bayes-spring-25.html](https://resteorts.github.io/teach/bayes-spring-25.html)

\vspace*{2em}


- Course syllabus [https://github.com/resteorts/modern-bayes/blob/master/syllabus/syllabus-sta602-fall-25.pdf](https://github.com/resteorts/modern-bayes/blob/master/syllabus/syllabus-sta602-fall-25.pdf)

\vspace*{2em}

- Please ask questions via Ed Discussion on Canvas. 
...
- Canvas (upload homeworks) (entire zipped files for reproducibility checks)
...
4 . TAs will be present to help (as able and as available) in these activities such that we can break into small groups and students can receive more individualized attention. 
...
3. Each lab TA will take questions (in person) or go over those posted to Ed Discussion. 
...
6. The first four our homeworks can be submitted in CanvAS and on Gradescope at anytime in case you want to work ahead. 
