...
Posterior derivation: Generalized preview
===

1. We begin with the **likelihood** of the normal distribution and write this in terms of $\theta$. 

2. We repeat the result for the **prior**

3. Finally, we combine the **likelihood** and **prior** and notice that our **posterior** is an updated Normal distribution. 

Likelihood
===

Let $x$ denote a single data point and $\ell$ denote the fixed and known precision. 
Let $\theta$ denote the unknown parameter of interest. 
...
===
We now consider the **prior** distribution on $\theta,$ where $\mu_0,\lambda_0$ are fixed and known. 
...
- One illustration of how "uniform priors" can be highly informative in the context of mixture models and clustering records to the underlying true unique entity. 
Steorts, Hall, Fienberg (2016): https://dukespace.lib.duke.edu/server/api/core/bitstreams/b67f6d5b-e458-4ca9-9140-90ddf4c917a7/content
