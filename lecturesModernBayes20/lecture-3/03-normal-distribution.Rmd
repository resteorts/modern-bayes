...
- We considered an application of human heights from Schlling et al. (2002), where we showed that the posterior probability of bimodality was zero (regarding a plot of combined heights). 