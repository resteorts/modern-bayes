...
\begin{align}
  &\textcolor{blue}{X_i \mid Z_i} = \branch{Z_i}{Z_i \leq c_i}{c_i}{Z_i > c_i},
\end{align}
...
abline(v = 2.65, col = "blue") 
abline(v = 4.07, col = "blue")
```


The estimated posterior density of theta
===

How do we interpret the estimated posterior density of $\theta$ given all other parameters in the model once we have run enough MCMC iterations?

1. This is the approximated posterior density of the rate of how long individuals are likely to live conditional on all the other parameters.
2. The red line is the posterior mean of this rate (see the code in the previous slide).
3. The blue lines represent a 95 percent confident region.


The estimated density of the ninth observation of z
===

How do we interpret the estimated posterior density of the ninth observation of $z$ once we have run enough MCMC iterations?

1. This is the approximated posterior density of the ninth censored random variable conditional on all the other parameters.
2. The red line is the posterior mean of this censored random variable (see the code in the previous slide).
3. You could add 95 percent confidence regions similar to those that were made for $\theta$


The estimated density of $z_{9}$
===
```{r, echo=FALSE}
