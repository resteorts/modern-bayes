...
- Homework 6 is now due Monday, October 12 at 5 PM EDT
- Lab on Friday will be used as time to help with this homework assignment or used to ask questions about practice problems that have been posted for the exam. 
- Lab 8 will be postposted until next week until I have introduced the material in class. 
- Please see the udpated webpage given that I have slowed down the pace of class based upon student feedback. 
- Exam II will be on October 29th. No class on Election Day. 
- I posted many practice questions for Exam II over the weekend. 
- We will go over the exam format together soon as a class and I will answer questions. 
...
If $X_i$ is observed (without missingness) and assuming no noise, then 
$$Z_i = X_i.$$

If $X_i$ is a censored value, then $X_i = c_i.$ This means that 
...
\item Since the second patient $X_2$ is censored, we know that $X_2 = 3+.$ This means that $Z_2 > 6.$
\end{enumerate}
...
Thus, $Y$ is a sample from the truncated Gamma.
