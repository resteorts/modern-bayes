...
<!-- How do we interpret the estimated posterior density of $\z_{9} \mid $ once we have run enough MCMC iterations?  -->
...
<!-- 3. You could add 95 percent confidence regions similar to those that were made for $\theta \mid  $ -->
