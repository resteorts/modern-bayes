...
How do we interpret the estimated posterior density of $\theta \mid -$ once we have run enough MCMC iterations? 

1. This is the approximated posterior density of how long individuals are likely to live conditional on all the other parameters. 
2. The red line is the posterior mean (see the code in the previous slide). 
