...
Our data points $Y_1,\ldots,Y_n$ come from a mixture model:

\begin{align}
Y_i \sim \sum_{j=1}^3 N(\mu_j,\varepsilon^2)
\end{align}

For each data point, define $Z_i$ to be a latent variable such that 
$$P(Z_i = j) = w_j$$ for $j=1,2,3.$ This implies that

\begin{align}
Y_i\mid Z_i  \sim  N(\mu_{Z_i},\varepsilon^2).
\end{align}
...
\textbf{On Friday, your TA will go through the lab and answer questions that you have. Please post to Piazza if you have specific questions that you'd like each TA to go through in more detail.}
