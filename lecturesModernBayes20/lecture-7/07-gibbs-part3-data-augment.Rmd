...
Data augmentation for latent/auxiliary variables
===
\begin{itemize}
\item A commonly-used technique for designing MCMC samplers is to use \emph{data augmentation}, also known as \emph{latent/auxiliary variables}.
