...
- The Dirichlet-Multinomial Supplement provides a more in depth treatment of this material:
[The Dirichlet-Multinomial Supplement](https://github.com/resteorts/modern-bayes/blob/master/lecturesModernBayes20/lecture-7/dirichlet-multinomial-supplement.pdf) 



Dirichlet
===
A Dirichlet distribution\footnote{This is the multivariate version of the Beta distribution.} is a distribution of the $K-1$-dimensional probability simplex\footnote{In geometry, a simplex is a generalization of the notion of a triangle or tetrahedron to arbitrary dimensions.}
$$\bigtriangleup_{K-1} = \{(\pi_1,\ldots, \pi_k): \pi_k \geq 0, \sum_k \pi_k = 1\}.$$
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/simplex-flat}
\end{center}
\end{figure}
