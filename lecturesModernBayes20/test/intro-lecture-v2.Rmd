...
<i class="material-icons">calendar_today</i>&nbsp; Class: Tues/Th, 1:45 - 3:00 PM EST <br>
<i class="material-icons">calendar_today</i>&nbsp; OH: Tues/Th, 3:00 - 4:00 PM EST
...
<i class="material-icons">calendar_today</i>&nbsp; Lab-01: Fri, 12:00 - 1:15 PM EST <br>
<i class="material-icons">calendar_today</i>&nbsp; OH: Wed, 9:00 - 10:00 AM EST <br>
]
---
...
- The videos are compressed, and this was done on purposed for those in the class that migth have slow internet. I would suggest that everyone forks the repository to avoid any issues. 
...
Exam 1 will be released for 24 hours, starting at midnight EST (see date of syllabus). 

- You will have 4 hours to work on the exam during the 24 hour period. 
- During this time period, you are not to discuss the exam with anyone except the TA's and myself. 
- You should upload your solutions to Sakai in one pdf document. You have one hour to upload your document to Sakai. 
- You will be expected to note your starting time, finishing time, and upload time. 
- You will be expected to respect the honor code regarding the assignment regrading the time utilized. 
...
2. The exam will be released via Sakai. 

3. You will have 30 minutes to post your written solutions to Sakai in one .pdf. 
...
Exam 2 will most likely go this way, but I will assess this after Exam 1 to see how this worked and revise Exam 2 based upon student feedback, TA feedback, and my own assessment. 

Remark: The goal of these exams is to test your baseline knowledge of the course and not be stressful. Make sure you have a quite place on the day of the exam during the class period. 
