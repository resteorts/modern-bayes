...
- The exa(m will be open note/open book (open resources)
...
- You are to not talk/post/communicate with anyone about the exam until after the exam itself (or this is an honor code violation), so DO NOT post to Piazza! 
