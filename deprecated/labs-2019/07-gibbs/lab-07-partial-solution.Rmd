...
---
title: "Lab 7 Solutions, STA 360/602"
...
1. Consider the following Exponential model for observation(s) $x=(x_1,\ldots,x_n).$\footnote{Please note that in the attached data there are 40 observations, which can be found in \text{data-exponential.csv}.}:
...
We now run the Gibbs sampler and produce some results. In addition to traceplots, running averages such as the one below are a useful heuristic for visually assessing the convergence of the Markov chain.
