...
\date{Due at 5:00 PM Standard Eastern Time TBD}
\maketitle
...
\item (Imputation, 50 points, 10 points each) Hoff 7.4 (Marriage data), \textbf{This is left as an optional exercise.}
\end{enumerate}
\end{document}
