...
<!-- -->
```
a.  Load the data set into R and make it a data frame called \texttt{rain\_df}. What command did you use?

b.  How many rows and columns does \texttt{rain\_df} have? How do you know? (If there are not 5070 rows and 27 columns, you did something wrong in the first part of the problem.)

c.  What command would you use to get the names of the columns of \texttt{rain\_df}? What are those names?
...
g.  Create a new column called $\texttt{daily\_rain\_fall}$, which is the sum of the 24 hourly columns.
