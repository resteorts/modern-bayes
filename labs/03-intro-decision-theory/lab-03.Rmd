...
5.  Based on your plot of the frequentist risk, consider the three estimators---the constant, the mean, and the Bayes estimators. By inspection of the plot alone, can you comment on admissibility versus inadmissibility of the estimators. Hint: this is a tough question, so do your best to figure this out! 
...
Based on your plot of the frequentist risk, consider the three estimators— the constant, the mean, and the Bayes estimators. From the plot, can you determine which estimators are admissible? Explain.  
